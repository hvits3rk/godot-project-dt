...
var GREEN = Color(ProjectSettings.get_setting("Debug/green"))
var BLUE = Color(ProjectSettings.get_setting("Debug/blue"))
var RED = Color(ProjectSettings.get_setting("Debug/red"))
var YELLOW = Color(ProjectSettings.get_setting("Debug/yellow"))
...
func _ready():
	var debug_node = get_tree().get_root().get_node("Main/Debug")
	if debug_node:
